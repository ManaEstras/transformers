...
"""Configuration class for HunYuanVL-MoT (Mixture of Tokens) model."""
...
class HunYuanVLMoTVisionConfig(PretrainedConfig):
    ...
    Copied from transformers.models.hunyuan_vl.HunYuanVLVisionConfig
    """
...
class HunYuanVLMoTTextConfig(PretrainedConfig):
    r"""
    Configuration class for HunYuanVL-MoT language model with Mixture of Tokens attention.
    
    The Mixture of Tokens (MoT) mechanism enables:
    ...
    Adapted from transformers.models.hunyuan_v1_dense.HunYuanDenseV1Config
...
class HunYuanVLMoTConfig(PretrainedConfig):
    ...
    def is_moe(self) -> bool:
        ...
        return False  # MoT variant does not use MoE, uses Mixture of Tokens instead
