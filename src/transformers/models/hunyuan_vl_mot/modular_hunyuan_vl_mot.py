...
"""Modular definition for HunYuanVL-MoT (Mixture of Tokens) multimodal model.

This file defines the modular composition.  Running `make fixup` from
the `transformers/` directory will auto-generate `modeling_hunyuan_vl_mot.py`.
...
- Flash Attention 2 via `flash_attn_varlen_func` is **required** (hard dependency)
  ...
  for vision segments.
- Vision encoder wraps SigLIPViTAnysizeWrapper from `_siglip_vit_anyres.py`.
- Weight keys match ckpt0228 exactly: `_v` suffix for vision modules
...
# ============================================================================
# MoT (Mixture of Tokens) helpers — new to this model
# ============================================================================
